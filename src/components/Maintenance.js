            ...
            <div className="flex h-screen bg-off-white">
                <div className="m-auto px-8 md:px-0">
                    ...
                    <div className="flex justify-center mt-4">
                        <a href="https://discord.gg/VYCCKKjnfu" target={'_blank'} rel="noreferrer">
                            <svg className="h-8 w-8 fill-current text-white cursor-pointer animate-wiggle" viewBox="0 0 71 55" xmlns="http://www.w3.org/2000/svg">
