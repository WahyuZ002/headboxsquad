...
const teams = [
    {
        name: 'Maza',
        position: 'Director',
        social_media_link: 'https://twitter.com/maza_zhr',
        pfp: Images.Team1,
        icon: 'twitter',
    },
    {
        ...
        social_media_link: 'https://twitter.com/MikailYordan012',
        pfp: Images.Team2,
        icon: 'twitter',
    },
    {
        name: 'DZ',
        position: 'Writer',
        social_media_link: 'http://instagram.com/dianzeirlina',
        pfp: Images.Team3,
        icon: 'instagram',
    },
    {
        ...
        social_media_link: 'http://twitter.com/amrukun',
        pfp: Images.Team4,
        icon: 'twitter',
    },
    {
        name: 'Raihan',
        position: 'Illustrator',
        social_media_link: 'http://instagram.com/raihanwhyuu',
        pfp: Images.Team5,
        icon: 'instagram',
    },
]
                        ...
                        {teams.map((person) => (
                            <div>
                                ...
                                <div className="mt-3 flex items-center justify-between">
                                    ...
                                    {person.icon === 'twitter' ? (
                                        <a href={person.social_media_link} target="_blank" rel="noreferrer">
                                            <svg
