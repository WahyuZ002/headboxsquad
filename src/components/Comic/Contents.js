...
import Comic2 from '../../assets/comics/2.png'
import Comic3 from '../../assets/comics/3.png'
import Comic4 from '../../assets/comics/4.png'
import Comic5 from '../../assets/comics/5.png'
import Comic6 from '../../assets/comics/6.png'
            ...
            <div className="mt-12 md:mt-28 px-12 text-gray-300 font-medium">
                <div className="flex flex-col md:flex-row items-center gap-6 mb-12">
                    <div className="md:md:w-1/4">
                        <img className="border-4 border-gray-200" src={Comic1} alt="" />
                    </div>
                ...
                <div className="flex flex-col-reverse md:flex-row items-center gap-6 mb-12">
                    ...
                    <div className="md:w-1/4">
                        <img className="border-4 border-gray-200" src={Comic2} alt="" />
                    </div>
                </div>
                <div className="flex flex-col md:flex-row items-center gap-6 mb-12">
                    <div className="md:w-1/4">
                        <img className="border-4 border-gray-200" src={Comic3} alt="" />
                    </div>
                    <div className="md:w-3/4">
                        <p>
                ...
                <div className="flex flex-col-reverse md:flex-row items-center gap-6 mb-12">
                    ...
                    <div className="md:w-1/4">
                        <img className="border-4 border-gray-200" src={Comic4} alt="" />
                    </div>
                </div>
                <div className="flex flex-col md:flex-row items-center gap-6 mb-12">
                    <div className="md:w-1/4">
                        <img className="border-4 border-gray-200" src={Comic5} alt="" />
                    </div>
                    <div className="md:w-3/4">
                        <p>
                ...
                <div className="flex flex-col-reverse md:flex-row items-center gap-6">
                    ...
                    <div className="md:w-1/4">
                        <img className="border-4 border-gray-200" src={Comic6} alt="" />
                    </div>
                </div>
                <div className="flex justify-center py-36">
                    <div className="w-full md:w-3/4 bg-semi-dark py-16 rounded-xl">
                        ...
                        <a href="https://discord.gg/XVkSZBdp" target="_blank" className="flex justify-center mt-8" rel="noreferrer">
                            <svg
                                ...
                                className="fill-current text-white hover:text-primary transition-all duration-300 ease-in-out cursor-pointer animate-wiggle"
                            >
